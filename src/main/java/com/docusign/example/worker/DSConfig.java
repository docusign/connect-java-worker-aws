...
public final class DSConfig {
    ...
    public static final String QUEUE_REGION;
    public static final String DEBUG;
    public static final String SALES_ORDER;
    public static final String AWS_ACCOUNT;
    public static final String AWS_SECRET;
    public static final String ENABLE_BREAK_TEST;
    public static final String ENVELOPE_CUSTOM_FIELD;
    ...
    static {
        ...
        DEBUG = fetchValue(config, "DEBUG");
        QUEUE_URL = fetchValue(config, "QUEUE_URL");
        QUEUE_REGION = fetchValue(config, "QUEUE_REGION");
        SALES_ORDER = fetchValue(config, "SALES_ORDER");
        AWS_ACCOUNT = fetchValue(config, "AWS_ACCOUNT");
        AWS_SECRET = fetchValue(config, "AWS_SECRET");
        ENABLE_BREAK_TEST = fetchValue(config, "ENABLE_BREAK_TEST");
        ENVELOPE_CUSTOM_FIELD = fetchValue(config, "ENVELOPE_CUSTOM_FIELD");
        OUTPUT_FILE_PREFIX = fetchValue(config, "OUTPUT_FILE_PREFIX");
